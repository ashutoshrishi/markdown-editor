...
var _user$project$Component_Editor$withCursorLine = F3(
	function (cursor, lines, transform) {
		var _p0 = lines;
		if (_p0.ctor === '[]') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
...
var _user$project$Component_Editor$makeHeading = function (_p3) {
	var _p4 = _p3;
	var lines = _elm_lang$core$String$lines(_p4.content);
	var transformed = A3(
	...
	return _elm_lang$core$Native_Utils.update(
		_p4,
		{
			content: A2(_elm_lang$core$String$join, '\n', transformed)
		});
};
...
var _user$project$Component_Editor$toggleWrapRange = F5(
	function (wrap, str, sel, start, end) {
		if (_elm_lang$core$Native_Utils.eq(sel, '')) {
			return str;
		} else {
			var wrapped = A2(_user$project$Component_Editor$toggleWrap, wrap, sel);
...
var _user$project$Component_Editor$previewView = function (model) {
	return A2(
...
var _user$project$Component_Editor$moveCursor = _elm_lang$core$Native_Platform.outgoingPort(
	'moveCursor',
	function (v) {
		return [v._0, v._1];
	});
...
var _user$project$Component_Editor$selectionWrap = F2(
	function (wrap, model) {
		...
		var newContent = A5(_user$project$Component_Editor$toggleWrapRange, wrap, model.content, sel.text, sel.start, sel.end);
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Component_Editor$makeEmphasis = _user$project$Component_Editor$selectionWrap('_');
var _user$project$Component_Editor$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			...
			case 'Edited':
				var _p6 = _p5._0;
				var formatted = A2(_elm_lang$core$Debug$log, 'Content', _p6);
				return {
					ctor: '_Tuple2',
			...
			case 'Emphasis':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Component_Editor$makeEmphasis(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Selected':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selected: A2(_elm_lang$core$Debug$log, 'SELECTED', _p5._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Component_Editor$Header = {ctor: 'Header'};
var _user$project$Component_Editor$Emphasis = {ctor: 'Emphasis'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_user$project$Component_Editor$makeToolButton, 'Emphasis', _user$project$Component_Editor$Emphasis),
				A2(_user$project$Component_Editor$makeToolButton, 'H1', _user$project$Component_Editor$Header)
			]));
};
...
var _user$project$Component_Editor$Blank = {ctor: 'Blank'};
var _user$project$Component_Editor$subscriptions = function (model) {
	var check = function (key) {
		return ((_elm_lang$core$Native_Utils.cmp(key, 65) > -1) && (_elm_lang$core$Native_Utils.cmp(key, 90) < 1)) ? _user$project$Component_Editor$Blank : _user$project$Component_Editor$CheckSelection;
	};
...
var _user$project$Component_Editor$editorView = function (model) {
	...
	return _circuithub$elm_bootstrap_html$Bootstrap_Html$row_(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Component_Editor$editorView(model)
					])),
				A4(
				_circuithub$elm_bootstrap_html$Bootstrap_Html$colMd_,
				12,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Component_Editor$previewView(model)
					]))
			]));
};

var _user$project$Main$Model = function (a) {
	return {editorModel: a};
};
...
var _user$project$Main$init = function () {
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$Main$Model(editorInit),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$EditorMsg, em)
	};
}();
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		var _p2 = A2(_user$project$Component_Editor$update, _p1._0, model.editorModel);
		var newEditor = _p2._0;
		var newMsg = _p2._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Markdown Editor')
											]))
									]))
							]))
					])),
